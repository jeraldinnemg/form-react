...
function App() {
  ...
  const [userEdad, setUserEdad] = useState("");
  ...
  const onChangeUserEdad = (event) => {
    setUserEdad(event.target.value);
  };
  ...
  const handleSubmit = (event) => {
    ...
    const isCompleteInput = completeInput(userName, userApellido, userMail);

    if (selectValue === "") {
      setErrorSelect("seleccionar un médico");
